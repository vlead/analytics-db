...
* Milestones Snapshot
  ...
  |   | no | no | Map |                    |      |        | hrs | hrs |        |
  |---+----+----+-----+--------------------+------+--------+-----+-----+--------|
  |   |  1 | [[https://github.com/vlead/analytics-db/milestone/2][2]]  |     | [[https://github.com/vlead/analytics-db/milestone/2][Service deployment]] |      | Closed | 104 | 132 | [[https://github.com/vlead/analytics-db/milestones/ADS%2520deployment%2520and%2520implementation%2520of%2520backup%2520restore%2520script][ref]]    |
  |---+----+----+-----+--------------------+------+--------+-----+-----+--------|
