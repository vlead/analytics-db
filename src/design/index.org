...
** To store the usage analytics of labs running on college cloud platform   
    ...
    - Example REST API ::
      ...
      #+END_EXAMPLE
** To store the user session analytics of Virtual Labs Website (on openedx platform)
...
** To store the user analytics of Virtual Labs Website (on openedx platform)
